  ...
  (do
    (def cases
      [;; Invalid
       ...
       "[[kur2206020921.+.학습 주도 개발로 나만의 음악 앱 만들기=q=]]"
       "<p><a href=\"kur2206020921.학습 주도 개발로 나만의 음악 앱 만들기?\">학습 주도 개발로 나만의 음악 앱 만들기?</a></p>\n"
       ;; if not md(has extension), convert path under resource dir
       "[[abc.png]]"        "<p><a href=\"resource/abc.png\">resource/abc.png</a></p>\n"
       "[[abc.png|aaasss]]" "<p><a href=\"resource/abc.png\">aaasss</a></p>\n"
       "[[글댓비full.png]]"  "<p><a href=\"resource/글댓비full.png\">resource/글댓비full.png</a></p>\n"
       ;; Display title only when file name is valid form: id.meta.title
       "[[kur2302130907.+.근로저Clojure 입문 - Hello World]]"
       "<p><a href=\"kur2302130907.근로저Clojure 입문 - Hello World\">근로저Clojure 입문 - Hello World</a></p>\n"
       "[[kur1701091416.+.={=CS=;=APP 13-1=}= Linking 1 - 어떻게 링킹 에러를 피할까]]"
       "<p><a href=\"kur1701091416.[CS:APP 13-1] Linking 1 - 어떻게 링킹 에러를 피할까\">[CS:APP 13-1] Linking 1 - 어떻게 링킹 에러를 피할까</a></p>\n"
       ;; with heading
       "[[aaa#bbb ccc ddd]]" "<p><a href=\"aaa#bbb-ccc-ddd\">aaa#bbb-ccc-ddd</a></p>\n"
       ...
       "aa [[abc.png  ]] bb"
       "<p>aa <a href=\"resource/abc.png\">resource/abc.png</a> bb</p>\n"
       "[[aa ]]![[abc.png]] bb"
       "<p><a href=\"aa\">aa</a><img src=\"resource/abc.png\" alt=\"resource/abc.png\"> bb</p>\n"
       ;; Nested list
       "- [[abc.png]] [t](a)\n  - x [[bb.asd]] y"
       "<ul>\n<li><a href=\"resource/abc.png\">resource/abc.png</a> <a href=\"a\">t</a>\n<ul>\n<li>x <a href=\"resource/bb.asd\">resource/bb.asd</a> y</li>\n</ul>\n</li>\n</ul>\n"
       ;; mark
